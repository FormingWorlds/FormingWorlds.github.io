...
- **Do not hand-edit**: `dist/` (build output), the vendor files under `public/assets/` (the bundled theme and scripts, maintained upstream), and the `badges` branch (generated by the coverage workflow).
